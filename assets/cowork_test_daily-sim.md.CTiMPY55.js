...
우선순위와 예상 소요 시간을 포함해서 내일 시간표를 만들어줘.`}]}},f=g("marketer"),b=g(null),u=g(!1),p=m(()=>{var t;return((t=M[f.value])==null?void 0:t.tasks)||[]}),c=m(()=>p.value.reduce((t,n)=>t+n.before,0)),v=m(()=>p.value.reduce((t,n)=>t+n.after,0)),h=m(()=>c.value-v.value),P=m(()=>Math.max(...p.value.map(t=>t.before)));function d(t){const n=Math.floor(t/60),a=t%60;return n===0?`${a}분`:a===0?`${n}시간`:`${n}시간 ${a}분`}function y(t){return Math.max(4,t/P.value*100)}function w(t,n){return t===n?0:Math.round((1-n/t)*100)}function T(t){t!==f.value&&(u.value=!0,b.value=null,setTimeout(()=>{f.value=t,R(()=>{setTimeout(()=>{u.value=!1},50)})},300))}function j(t){b.value=b.value===t?null:t}const N=m(()=>{const t=h.value,n=[];return t>=240&&n.push("전략적 사고와 기획에 집중"),t>=180&&n.push("새로운 스킬 학습 (온라인 강의 1개)"),t>=120&&n.push("팀원 1:1 미팅 2-3건"),t>=60&&n.push("네트워킹 커피챗"),n.push("운동 또는 산책으로 리프레시"),n.push("일찍 퇴근하기"),n});return(t,n)=>(r(),o("div",null,[n[7]||(n[7]=e("h1",{id:"하루-일과-시뮬레이터",tabindex:"-1"},[s("하루 일과 시뮬레이터 "),e("a",{class:"header-anchor",href:"#하루-일과-시뮬레이터","aria-label":'Permalink to "하루 일과 시뮬레이터"'},"​")],-1)),n[8]||(n[8]=e("blockquote",null,[e("p",null,"Claude와 함께하는 하루 vs 혼자 하는 하루. 시간대별로 얼마나 달라지는지 체험해보세요!")],-1)),n[9]||(n[9]=e("h2",{id:"직무를-선택하세요",tabindex:"-1"},[s("직무를 선택하세요 "),e("a",{class:"header-anchor",href:"#직무를-선택하세요","aria-label":'Permalink to "직무를 선택하세요"'},"​")],-1)),e("div",A,[(r(),o(k,null,_(B,a=>e("button",{key:a.id,class:C(["role-btn",{active:f.value===a.id}]),onClick:i=>T(a.id)},l(a.emoji)+" "+l(a.label),11,I)),64))]),n[10]||(n[10]=e("h2",{id:"하루-비교-요약",tabindex:"-1"},[s("하루 비교 요약 "),e("a",{class:"header-anchor",href:"#하루-비교-요약","aria-label":'Permalink to "하루 비교 요약"'},"​")],-1)),e("div",$,[e("div",O,[n[0]||(n[0]=e("div",{class:"label"},"Before (Claude 없이)",-1)),e("div",V,l(d(c.value)),1),n[1]||(n[1]=e("div",{class:"sub"},"순수 업무 시간",-1))]),e("div",D,[n[2]||(n[2]=e("div",{class:"label"},"After (Claude와 함께)",-1)),e("div",L,l(d(v.value)),1),n[3]||(n[3]=e("div",{class:"sub"},"동일 업무 완료",-1))]),e("div",z,[n[4]||(n[4]=e("div",{class:"label"},"절약된 시간",-1)),e("div",F,l(d(h.value)),1),e("div",q,l(Math.round((1-v.value/c.value)*100))+"% 단축",1)])]),n[11]||(n[11]=e("h2",{id:"시간대별-타임라인",tabindex:"-1"},[s("시간대별 타임라인 "),e("a",{class:"header-anchor",href:"#시간대별-타임라인","aria-label":'Permalink to "시간대별 타임라인"'},"​")],-1)),n[12]||(n[12]=e("p",{class:"click-hint"},"각 업무를 클릭하면 실제 프롬프트 예시를 볼 수 있습니다",-1)),e("div",{class:C(["timeline-container",{animating:u.value}])},[n[6]||(n[6]=e("div",{class:"timeline-header"},[e("div"),e("div",{class:"h-before"},"Before (Claude 없이)"),e("div",{class:"h-after"},"After (Claude와 함께)")],-1)),(r(!0),o(k,null,_(p.value,(a,i)=>(r(),o("div",{key:f.value+"-"+i,class:"task-row",onClick:le=>j(i)},[e("div",H,[e("div",J,l(a.time),1),e("div",K,[e("div",U,[e("div",{class:"bar before-bar",style:S({width:y(a.before)+"%"})},l(a.label),5),e("span",W,l(a.before)+"분",1)])]),e("div",G,[e("div",Q,[e("div",{class:C(["bar",a.before===a.after?"same-bar":"after-bar"]),style:S({width:y(a.after)+"%"})},l(a.label),7),e("span",X,l(a.after)+"분",1),a.before!==a.after?(r(),o("span",Y,"-"+l(w(a.before,a.after))+"%",1)):x("",!0)])])]),b.value===i?(r(),o("div",Z,[n[5]||(n[5]=e("div",{class:"prompt-title"},"💬 Claude에게 이렇게 요청하세요",-1)),e("pre",null,l(a.prompt),1)])):x("",!0)],8,E))),128))],2),n[13]||(n[13]=e("h2",{id:"절약된-시간으로-할-수-있는-것",tabindex:"-1"},[s("절약된 시간으로 할 수 있는 것 "),e("a",{class:"header-anchor",href:"#절약된-시간으로-할-수-있는-것","aria-label":'Permalink to "절약된 시간으로 할 수 있는 것"'},"​")],-1)),e("div",ee,[e("div",ne,l(d(h.value))+"이 생기면?",1),e("ul",null,[(r(!0),o(k,null,_(N.value,(a,i)=>(r(),o("li",{key:i},l(a),1))),128))])]),n[14]||(n[14]=e("div",{class:"tip custom-block"},[e("p",{class:"custom-block-title"},"핵심 포인트"),e("p",null,[s("회의처럼 사람이 직접 해야 하는 일은 시간이 동일하지만, "),e("strong",null,"문서 작성, 분석, 정리"),s(" 등 대부분의 데스크 업무에서 50~80% 시간을 절약할 수 있습니다. 절약된 시간은 더 "),e("strong",null,"창의적이고 전략적인 일"),s("에 투자하세요!")])],-1))]))}});export{oe as __pageData,se as default};
