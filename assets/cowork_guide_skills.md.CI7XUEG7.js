...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;">---</span></span></code></pre></div><h2 id="실전-스킬-예제-10선" tabindex="-1">실전 스킬 예제 10선 <a class="header-anchor" href="#실전-스킬-예제-10선" aria-label="Permalink to &quot;실전 스킬 예제 10선&quot;">​</a></h2><h3 id="_1-📝-주간-업무-보고서" tabindex="-1">1. 📝 주간 업무 보고서 <a class="header-anchor" href="#_1-📝-주간-업무-보고서" aria-label="Permalink to &quot;1. 📝 주간 업무 보고서&quot;">​</a></h3><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">name</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">weekly-report</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">description</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">주간 업무 보고서를 회사 양식에 맞춰 작성합니다. 사용자가 주간 보고, 위클리 리포트, 금주 실적 정리, 이번 주 보고서를 요청할 때 활성화됩니다.</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 차주 계획은 SMART 기준으로 작성 (구체적, 측정 가능, 달성 가능, 관련성, 기한)</span></span></code></pre></div><h3 id="_2-📧-비즈니스-이메일-작성" tabindex="-1">2. 📧 비즈니스 이메일 작성 <a class="header-anchor" href="#_2-📧-비즈니스-이메일-작성" aria-label="Permalink to &quot;2. 📧 비즈니스 이메일 작성&quot;">​</a></h3><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">name</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">biz-email</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">description</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">비즈니스 이메일을 작성합니다. 사용자가 이메일 작성, 메일 보내기, 거래처 연락, 회신 작성, 공식 메일을 요청할 때 활성화됩니다. 한국어 비즈니스 이메일 관례를 따릅니다.</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Action Item에는 반드시 담당자와 기한 포함</span></span></code></pre></div><h3 id="_4-📊-데이터-요약-리포트" tabindex="-1">4. 📊 데이터 요약 리포트 <a class="header-anchor" href="#_4-📊-데이터-요약-리포트" aria-label="Permalink to &quot;4. 📊 데이터 요약 리포트&quot;">​</a></h3><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">name</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">data-summary</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">description</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">데이터를 분석하여 경영진용 요약 리포트를 작성합니다. 사용자가 데이터 분석, 수치 정리, 실적 요약, 대시보드 리포트를 요청하거나 CSV/표 데이터를 붙여넣을 때 활성화됩니다.</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 전문 용어 사용 시 괄호로 설명 추가</span></span></code></pre></div><h3 id="_5-✅-기획서-검토" tabindex="-1">5. ✅ 기획서 검토 <a class="header-anchor" href="#_5-✅-기획서-검토" aria-label="Permalink to &quot;5. ✅ 기획서 검토&quot;">​</a></h3><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">name</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">doc-review</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">description</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">기획서, 제안서, 보고서를 체계적으로 검토하고 피드백을 제공합니다. 사용자가 문서 검토, 기획서 피드백, 제안서 리뷰, 보고서 점검을 요청하거나 문서를 붙여넣으며 의견을 구할 때 활성화됩니다.</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (선택적 개선 아이디어)</span></span></code></pre></div><h3 id="_6-📋-일일-업무-정리" tabindex="-1">6. 📋 일일 업무 정리 <a class="header-anchor" href="#_6-📋-일일-업무-정리" aria-label="Permalink to &quot;6. 📋 일일 업무 정리&quot;">​</a></h3><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">name</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">daily-wrap</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">description</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">하루 업무를 정리하고 내일 할 일을 계획합니다. 사용자가 오늘 업무 정리, 일일 보고, 퇴근 전 정리, 하루 마무리, 내일 계획을 요청할 때 활성화됩니다.</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 내일 계획은 항상 우선순위순으로 정렬</span></span></code></pre></div><h3 id="_7-💼-거래처-이메일-번역" tabindex="-1">7. 💼 거래처 이메일 번역 <a class="header-anchor" href="#_7-💼-거래처-이메일-번역" aria-label="Permalink to &quot;7. 💼 거래처 이메일 번역&quot;">​</a></h3><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">name</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">biz-translate</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">description</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">비즈니스 이메일과 문서를 한영/영한 번역합니다. 사용자가 이메일 번역, 영문 메일 작성, 한영 번역, 거래처 서신 번역을 요청하거나 외국어 이메일을 붙여넣을 때 활성화됩니다.</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">3.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 톤/뉘앙스 참고 사항 (필요 시)</span></span></code></pre></div><h3 id="_8-🎯-okr-kpi-작성-도우미" tabindex="-1">8. 🎯 OKR/KPI 작성 도우미 <a class="header-anchor" href="#_8-🎯-okr-kpi-작성-도우미" aria-label="Permalink to &quot;8. 🎯 OKR/KPI 작성 도우미&quot;">​</a></h3><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">name</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">okr-helper</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">description</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">OKR과 KPI를 작성하고 점검합니다. 사용자가 OKR 작성, KPI 설정, 목표 수립, 분기 목표, 성과 지표를 요청할 때 활성화됩니다.</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> [ ] 팀원 모두가 이해할 수 있는 표현인가?</span></span></code></pre></div><h3 id="_9-📑-사내-공지-작성" tabindex="-1">9. 📑 사내 공지 작성 <a class="header-anchor" href="#_9-📑-사내-공지-작성" aria-label="Permalink to &quot;9. 📑 사내 공지 작성&quot;">​</a></h3><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">name</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">announcement</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">description</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">사내 공지사항을 작성합니다. 사용자가 공지 작성, 사내 안내문, 전사 메일, 부서 공지, 인사 발령 공지를 요청할 때 활성화됩니다.</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 끝에 반드시 문의처 명시</span></span></code></pre></div><h3 id="_10-🧹-프롬프트-다듬기" tabindex="-1">10. 🧹 프롬프트 다듬기 <a class="header-anchor" href="#_10-🧹-프롬프트-다듬기" aria-label="Permalink to &quot;10. 🧹 프롬프트 다듬기&quot;">​</a></h3><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">name</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">prompt-refiner</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">description</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">사용자의 프롬프트를 더 효과적으로 개선합니다. 사용자가 프롬프트 개선, 질문 다듬기, 더 좋은 프롬프트로 바꿔줘, 이 프롬프트 수정해줘를 요청할 때 활성화됩니다.</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
<span class="line"></span>
