import{o as l,c as s,j as n,a as p,F as v,B as h,t as a,e as c,p as f,h as g,P as T}from"./chunks/framework.DvFsUg-r.js";const I={class:"dt-container"},O={key:0,class:"dt-breadcrumb"},j=["onClick"],R={key:1,class:"dt-crumb-current"},V={key:2,class:"dt-crumb-choice"},B={key:3,class:"dt-crumb-sep"},S={key:1,id:"dt-current",class:"dt-question-card"},N={class:"dt-question-badge"},D={class:"dt-question-step"},E={class:"dt-question-text"},Q={class:"dt-options"},$=["onClick"],F={class:"dt-option-icon"},M={class:"dt-option-label"},W={key:2,id:"dt-current",class:"dt-result-card"},A={class:"dt-result-title"},J={class:"dt-result-section"},K=["href"],U={class:"dt-result-section"},z={class:"dt-prompt-box"},G={class:"dt-prompt-text"},H={key:0,class:"dt-result-section"},X={class:"dt-workflow"},Y={key:1,class:"dt-result-section"},Z={class:"dt-tip"},ee={class:"dt-result-section"},ne={class:"dt-template-links"},te=["href"],oe=JSON.parse('{"title":"어떤 기능을 쓸까?","description":"","frontmatter":{},"headers":[],"relativePath":"cowork/resources/decision-tree.md","filePath":"cowork/resources/decision-tree.md","lastUpdated":1781092690000}'),le={name:"cowork/resources/decision-tree.md"},re=Object.assign(le,{setup(se){const o=f("q1"),d=f([]),y={q1:{question:"지금 하려는 일은?",options:[{icon:"📝",label:"문서/글 작성",next:"q2a"},{icon:"📊",label:"데이터 분석/정리",next:"q2b"},{icon:"🤝",label:"회의/협업",next:"q2c"},{icon:"🔄",label:"반복 업무 자동화",next:"q2d"},{icon:"🔍",label:"자료 조사/리서치",next:"q2e"},{icon:"🌐",label:"번역/다국어",next:"q2f"}]},q2a:{question:"어떤 종류의 문서?",options:[{icon:"✉️",label:"이메일",next:"r_email"},{icon:"📑",label:"보고서/기획서",next:"r_report"},{icon:"📢",label:"공지/안내문",next:"r_notice"},{icon:"✏️",label:"퇴고/다듬기",next:"r_polish"}]},q2b:{question:"데이터 형태는?",options:[{icon:"📗",label:"엑셀/CSV",next:"r_excel"},{icon:"📄",label:"비정형 메모/텍스트",next:"r_memo"},{icon:"📋",label:"설문/피드백",next:"r_survey"}]},q2c:{question:"회의 단계는?",options:[{icon:"📌",label:"회의 전 (안건 준비)",next:"r_pre_meeting"},{icon:"⚡",label:"회의 중 (실시간 노트)",next:"r_during_meeting"},{icon:"📝",label:"회의 후 (정리/공유)",next:"r_post_meeting"}]},q2d:{question:"얼마나 자주?",options:[{icon:"☀️",label:"매일",next:"r_daily"},{icon:"📅",label:"매주",next:"r_weekly"},{icon:"🗓️",label:"매달",next:"r_monthly"}]},q2e:{question:"리서치 목적은?",options:[{icon:"🏢",label:"경쟁사/시장 분석",next:"r_competitor"},{icon:"📚",label:"내부 자료 요약",next:"r_summary"},{icon:"📈",label:"트렌드 파악",next:"r_trend"}]},q2f:{question:"번역 방향?",options:[{icon:"🇰🇷",label:"한→영",next:"r_ko_en"},{icon:"🇺🇸",label:"영→한",next:"r_en_ko"},{icon:"🌍",label:"다국어 동시",next:"r_multi"}]}},x={r_email:{title:"이메일 작성 도우미",page:"문서 작성 > 이메일 섹션",link:"/guide/writing#이메일",prompt:`다음 조건으로 업무 이메일을 작성해줘:
- 받는 사람: [상대방]
- 목적: [요청/안내/회신 등]
- 핵심 내용: [전달 사항]
- 톤: 정중하고 간결한 비즈니스 격식체
